Start-Process ./atv2-seq.exe -RedirectStandardInput ./testes/teste-spec.txt -NoNewWindow -Wait; 
Start-Process ./atv2-seq.exe -RedirectStandardInput ./testes/teste-40.txt -NoNewWindow -Wait; 
Start-Process ./atv2-seq.exe -RedirectStandardInput ./testes/teste-100.txt -NoNewWindow -Wait; 
